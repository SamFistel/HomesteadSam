...
const BibInput = ({ onObjectReceived }) => {
    ...
    const handleButtonClick = () => {
        ...
        xhr.open('GET', 'https://my4.raceresult.com/192607/RRPublish/data/list?key=9d484a9a9259ff0ae1a4a8570861bc3b&fav=&listname=Online%7CLap%20Details&page=live&contest=0&r=bib2&bib=' + inputValue); // 2022
